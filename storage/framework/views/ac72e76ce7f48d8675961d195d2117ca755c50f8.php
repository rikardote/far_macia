...
<html>
    <head>
        ...
        <title><?php echo $__env->yieldContent('title'); ?> | HOSPITAL GENERAL "5 DE DICIEMBRE"</title>
    ...
    <body>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><a href="<?php echo e(route('dashboard')); ?>" class="brand-logo darken-1">HOSPITAL GENERAL "5 DE DICIEMBRE"</a><span class="logo-text">HOSPITAL GENERAL "5 DE DICIEMBRE"</span></h1></li>
                        </ul>
        ...
        <footer class="page-footer">
            <div class="footer-copyright">
                <div class="container">
                    <span>Creado por <a class="grey-text text-lighten-3" href="#" target="_blank">Hector Ricardo Fuentes Armenta</a> Derechos reservados.</span>
