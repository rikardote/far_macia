...
<html>
    <head>
        ...
        <title>@yield('title') | HOSPITAL GENERAL "5 DE DICIEMBRE"</title>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><a href="{{ route('dashboard') }}" class="brand-logo darken-1">HOSPITAL GENERAL "5 DE DICIEMBRE"</a><span class="logo-text">HOSPITAL GENERAL "5 DE DICIEMBRE"</span></h1></li>
                        </ul>
